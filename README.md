...
## This project was part of my Data Science immersive course at General Assembley Sydney.  The Dataset required a significant amount of cleaning and feature engineering in order to be ready for modelling.  I got to implement alot of exploratory analysis and python data munging techniques.  The nature of the data having a high number of features allowed for some interesting insight into the process of feature selection via a variety of approaches.  I was also able to compare quite a few different modelling approaches in both regressiona and classification.  To exhibit some of my visualisation skills I did a plotly viz of the effects of l2 regularization (ridge) on my feature coefficients.  This viz is useful to understand the effect of the changing alpha penalty on the feature weights.
## Business Case
